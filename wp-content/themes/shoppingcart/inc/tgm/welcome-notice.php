...
function shoppingcart_admin_css (){

  wp_enqueue_style( 'shoppingcart-admin-css', get_template_directory_uri() . '/css/admin/admin.css' );

}

add_action( 'admin_enqueue_scripts', 'shoppingcart_admin_css' );
...
function shoppingcart_admin_notice() {
  ...
  if ( !get_user_meta( $current_user_id, esc_html( $theme->get( 'TextDomain' ) ) . '_notice_ignore' ) ) {
    ?>
    <div class="notice shoppingcart-notice">
