...
//footer Link
define('LZ_FASHION_ECOMMERCE_CREDIT','https://www.luzuk.com/themes/free-fashion-wordpress-theme/','lz-fashion-ecommerce');

if ( ! function_exists( 'lz_fashion_ecommerce_credit' ) ) {
function lz_fashion_ecommerce_credit(){
echo "<a href=".esc_url(LZ_FASHION_ECOMMERCE_CREDIT)." target='_blank'>".esc_html__('Fashion Ecommerce Theme.','lz-fashion-ecommerce')."</a>";
}
}
...
add_filter('loop_shop_columns', 'lz_fashion_ecommerce_loop_columns');
	if (!function_exists('lz_fashion_ecommerce_loop_columns')) {
		function lz_fashion_ecommerce_loop_columns() {
